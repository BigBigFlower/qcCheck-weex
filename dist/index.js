...
var _wxcLightbox = __webpack_require__(104);

var _wxcLightbox2 = _interopRequireDefault(_wxcLightbox);

var _wxcLoading = __webpack_require__(113);

var _wxcLoading2 = _interopRequireDefault(_wxcLoading);

var _wxcLotteryRain = __webpack_require__(118);
...
var _wxcRichText = __webpack_require__(184);
...
var _defaultData = __webpack_require__(42);
...
var _fullPage = __webpack_require__(85);
...
var _region = __webpack_require__(127);
...
exports.default = {
  components: {
    ...
    WxcRichTextIcon: __webpack_require__(194),
...
__vue_options__.__file = "D:\\Big_project\\awesome-app\\src\\views\\qcCheck.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-59fb31dc"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  methods: {
    ...
    // 获取列表
    queryInvoiceItemList: function queryInvoiceItemList(status) {
      var _this = this;

      var POST_URL = 'https://b2b.test.pagoda.com.cn/uniseq_buyer_phone/uniseq_micro_cgdd/dhzj/queryInvoiceItemList';
      stream.fetch({
        method: 'POST',
        url: POST_URL,
        type: 'json',
        ...
        if (!res.ok) {
          ...
          _this.checkLists = res.data.data;
        }
      }, function (response) {});
    },
    ...
    onDetail: function onDetail(item) {
      _index2.default.push('/qcItemDetail');
    }
  }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    style: _vm.onCheckStyle,
    on: {
      "click": _vm.onCheck
    }
  }, [_c('text', [_vm._v("待审核")])]), _c('div', {
    staticClass: ["btn_item"],
    style: _vm.haveCheckStyle,
    on: {
      "click": _vm.haveCheck
    }
  }, [_c('text', [_vm._v("已审核")])])])], 1), _c('list', {
    staticStyle: {
      backgroundColor: "#F8F8F8",
      marginTop: "180px"
    }
  }, [_vm._l((_vm.checkLists), function(item, index) {
    return _c('cell', {
      key: index,
      ...
      staticClass: ["check_update"]
    }, [_c('text', {
      staticStyle: {
        color: "#999"
      }
    }, [_vm._v(_vm._s(item.updatedTime))])]), _c('div', {
      staticClass: ["check_item"]
    }, [_c('div', {
      staticClass: ["check_item_content"]
    }, [_c('text', {
      staticClass: ["check_item_title"]
    }, [_vm._v("发货单号：")]), _c('text', {
      staticClass: ["list_content"]
    }, [_vm._v(_vm._s(item.invoiceNum))])]), _c('div', {
      staticClass: ["check_item_content"]
    }, [_c('text', {
      staticClass: ["check_item_title"]
    }, [_vm._v("商品名称：")]), _c('text', {
      ...
      staticClass: ["list_content"]
    }, [_vm._v(_vm._s(item.estimatedTime))])]), _c('div', {
      staticClass: ["check_item_content"]
    }, [_c('text', {
      staticClass: ["check_item_title"]
    }, [_vm._v("到货机构：")]), _c('text', {
      staticClass: ["list_content"]
    }, [_vm._v(_vm._s(item.orgName))])]), _c('div', {
      staticClass: ["check_item_content"]
    }, [_c('text', {
      staticClass: ["check_item_title"]
    }, [_vm._v("质检员：")]), _c('text', {
      staticClass: ["list_content"]
    }, [_vm._v(_vm._s(item.inspector))])]), _c('div', {
      staticClass: ["check_item_content"]
    }, [_c('text', {
      staticClass: ["check_item_title"]
    }, [_vm._v("质检意见：")]), _c('text', {
      staticClass: ["list_content"]
    }, [_vm._v(_vm._s(_vm.qualityResultText[item.qualityResult]))])])])])
  }), _c('loading', {
    staticClass: ["loading"],
    attrs: {
...
__vue_options__.__file = "D:\\Big_project\\awesome-app\\src\\index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "D:\\Big_project\\awesome-app\\src\\views\\qcItemDetail.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-adf84cac"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  components: {
    ...
    'my-header': _listHeader2.default
  },
  data: function data() {
    return {
      buyerName: '',
  ...
  methods: {
    ...
    // 获取列表
    getDhzjInfo: function getDhzjInfo(status) {
      var _this = this;

      var POST_URL = 'https://b2b.test.pagoda.com.cn/uniseq_micro_cgdd/dhzj/getDhzjInfo';
      stream.fetch({
        method: 'POST',
        url: POST_URL,
        type: 'json',
        ...
        if (!res.ok) {
          ...
          _this.reviewList = data.reviewList;
        }
      }, function (response) {});
    },
    ...
    // 填写质检意见
    handleAdvise: function handleAdvise() {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["dhInfo_title"]
  }, [_vm._v("供应商")]), _c('text', {
    staticClass: ["content"]
  }, [_vm._v(_vm._s(_vm.item.vendorName))])]), _c('cell', {
    staticClass: ["dhInfo"],
    appendAsTree: true,
    attrs: {
      "append": "tree"
    ...
    staticClass: ["content"]
  }, [_vm._v(_vm._s(_vm.buyerName))])]), _c('cell', {
    staticClass: ["dhInfo"],
    appendAsTree: true,
    attrs: {
      "append": "tree"
    ...
    staticClass: ["content"]
  }, [_vm._v(_vm._s(_vm.item.goodsName))])]), _c('cell', {
    staticClass: ["dhInfo"],
    appendAsTree: true,
    attrs: {
      "append": "tree"
    ...
    staticClass: ["content"]
  }, [_vm._v(_vm._s(_vm.item.orgName))])]), _c('cell', {
    staticClass: ["dhInfo"],
    appendAsTree: true,
    attrs: {
      "append": "tree"
    ...
    staticClass: ["content"]
  }, [_vm._v(_vm._s(_vm.item.deliveryNumber + _vm.item.purUnit))])])]) : _vm._e(), _c('div', {
    ...
    on: {
      "onShow": function($event) {
        _vm.qualityAdvise = !_vm.qualityAdvise
      }
    }
  }), _vm._l((_vm.reviewList), function(item, index) {
    return (_vm.qualityAdvise) ? _c('div', {
      key: index,
      staticStyle: {
        backgroundColor: "#F0F0F0"
      }
    }, [(item.createTime) ? _c('div', {
      staticClass: ["check_update"]
    }, [_c('text', {
      staticStyle: {
        color: "#999"
      }
    }, [_vm._v(_vm._s(item.createTime))])]) : _vm._e(), _c('div', {
      staticStyle: {
        backgroundColor: "#FFFFFF"
      }
    }, [(item.createUser) ? _c('div', {
      staticClass: ["dhInfo"]
    }, [_c('text', {
      staticClass: ["dhInfo_title"]
    }, [_vm._v(_vm._s(_vm.levelText[item.level]))]), (item.status !== 'A' && item.status !== 'B') ? _c('text', {
      staticClass: ["icon", "iconfont", "warning"],
      staticStyle: {
        width: "30px",
        color: "#FF0000"
      }
    }, [_vm._v("")]) : _vm._e(), (item.status === 'A' || item.status === 'B') ? _c('text', {
      staticClass: ["icon", "iconfont", "warning"],
      staticStyle: {
        width: "30px",
        color: "#00CC33"
      ...
      staticClass: ["advise_content"]
    }, [_vm._v(_vm._s(item.createUser))])]) : _vm._e(), (item.qualityAdvise) ? _c('div', {
      staticClass: ["dhInfo"]
    }, [_c('text', {
      staticClass: ["dhInfo_title"]
    }, [_vm._v("处理意见")]), _c('text', {
      staticClass: ["content"]
    }, [_vm._v(_vm._s(_vm.qualityAdviseText[item.qualityAdvise]))])]) : _vm._e(), (item.level === 'B' && item.updateGoodsName) ? _c('div', {
      staticClass: ["dhInfo"]
    }, [_c('text', {
      staticClass: ["dhInfo_title"]
    }, [_vm._v("转级单品")]), _c('text', {
      staticClass: ["content"]
    }, [_vm._v(_vm._s(item.updateGoodsName))])]) : _vm._e(), (item.level === 'B' && item.updatePrice) ? _c('div', {
      staticClass: ["dhInfo"]
    }, [_c('text', {
      staticClass: ["dhInfo_title"]
    }, [_vm._v("单价")]), _c('text', {
      staticClass: ["content"]
    }, [_vm._v(_vm._s(item.updatePrice))])]) : _vm._e(), (item.remark) ? _c('div', {
      staticClass: ["dhInfo"]
    }, [_c('text', {
      staticClass: ["dhInfo_title"]
    }, [_vm._v("备注")]), _c('text', {
      staticClass: ["content"]
    }, [_vm._v(_vm._s(item.remark))])]) : _vm._e(), (item.level === 'C' && item.status) ? _c('div', {
      staticClass: ["dhInfo"]
    }, [_c('text', {
      staticClass: ["dhInfo_title"]
    }, [_vm._v("审核状态")]), _c('text', {
      staticClass: ["content"]
    }, [_vm._v(_vm._s(_vm.statusText[item.status]))])]) : _vm._e()])]) : _vm._e()
  })], 2), _c('div', {
    staticClass: ["btn_tab"]
  }, [_c('div', {
    staticClass: ["btn_item"],
  ...
  }, [_c('text', [_vm._v("申请复检中")])]), _c('div', {
    staticClass: ["btn_item"],
    staticStyle: {
      backgroundColor: "rgb(31, 177, 106)"
    },
    on: {
      "click": _vm.handleAdvise
    }
  }, [_c('text', [_vm._v("填写处理意见")])])])])
},staticRenderFns: []}
module.exports.render._withStripped = true
...
var _vueRouter = __webpack_require__(263);

var _vueRouter2 = _interopRequireDefault(_vueRouter);

var _qcCheck = __webpack_require__(246);

var _qcCheck2 = _interopRequireDefault(_qcCheck);

var _qcItemDetail = __webpack_require__(258);

var _qcItemDetail2 = _interopRequireDefault(_qcItemDetail);
...
exports.default = new _vueRouter2.default({
  routes: [{
    path: '/qcCheck',
    component: _qcCheck2.default,
    name: 'qcCheck'
  }, {
    path: '/qcItemDetail',
    component: _qcItemDetail2.default,
    name: 'qcItemDetail'
  }, {
    path: '/',
    redirect: '/qcCheck'
